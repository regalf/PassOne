...
class SshEditScreen extends StatefulWidget {
  final VaultEntry? entry;

  const SshEditScreen({super.key, this.entry});

  @override
  State<SshEditScreen> createState() => _SshEditScreenState();
}

class _SshEditScreenState extends State<SshEditScreen> {
